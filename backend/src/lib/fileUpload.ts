...
export function buildBuildingImageKey(
  workspaceId: string,
  projectId: string,
  buildingId: string,
  uploadId: string,
...
export function s3KeyMatchesBuildingImage(
  s3Key: string,
  workspaceId: string,
  projectId: string,
  buildingId: string,
...
export function buildPunchReferencePhotoKey(
  workspaceId: string,
  projectId: string,
  uploadId: string,
  fileName: string,
...
export function s3KeyMatchesPunchReferencePhoto(
  s3Key: string,
  workspaceId: string,
  projectId: string,
): boolean {
