...
function storageBytesAndKeysFromPhotoJsonArray(v) {
    const keys = [];
    let bytes = 0n;
    if (!Array.isArray(v))
        return { keys, bytes };
...
export async function deleteFileFromS3AndDb(env, fileId) {
 ...
 */
export async function deleteFileVersionFromS3AndDb(env, fileId, version) {
...
export async function deleteFolderTreeFromDbAndS3(env, folderId) {
 ...
 */
export async function deleteProjectAndAssets(env, projectId) {
