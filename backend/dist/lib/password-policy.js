...
export const AUTH_PASSWORD_HINT = "At least 10 characters, with upper and lowercase letters, a number, and a symbol.";
export function isStrongAuthPassword(password) {
