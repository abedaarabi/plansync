...
import { extractStoreysFromIfc } from "../bim/storeyExtract.js";
...
export async function syncBuildingLevelsFromIfc(env, fileVersionId) {
...
export async function ensureBuildingLevelsSynced(env, buildingId) {
    ...
    for (const file of ifcFiles) {
        ...
        if (!fv || fv.bimConversionStatus !== "ready" || !fv.quantityIndexS3Key)
            continue;
