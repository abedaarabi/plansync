...
import { SOLUTION_ICON_COLORS } from "./solutionIcons";
        ...
        return (
          <AnimateIn className="grid items-center gap-10 scroll-mt-24 lg:grid-cols-2 lg:gap-16">
            <BrowserMockup variant="elevated">
              <div className="p-5 sm:p-6">
                <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                  <span className="text-sm font-semibold text-slate-900">Drawing revisions</span>
                ...
                <div className="mt-4 space-y-2.5">
                  {[
                    {
                      name: "M-101 — Structural plans.pdf",
                      rev: "Rev 04",
                      when: "Today · GC",
                      current: true,
                    },
                ...
                <p className="mt-4 rounded-lg border border-slate-200 bg-slate-50/80 px-3 py-2 text-xs text-slate-600">
                  RFIs and issues stay tied to the revision they were logged against — open the
                  right sheet without guessing which attachment is current.
                </p>
              </div>
            </BrowserMockup>
            <div className={PANEL}>
