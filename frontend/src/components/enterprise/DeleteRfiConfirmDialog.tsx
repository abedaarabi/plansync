...
export function DeleteRfiConfirmDialog({
  open,
  reference,
  title,
  onConfirm,
  ...
  return (
    <EnterpriseResponsiveDialog
      ...
      role="alertdialog"
      ariaLabelledBy="delete-rfi-title"
      ariaDescribedBy="delete-rfi-desc"
      ...
      <div className="flex gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          >
            ...
            removed permanently, including attachments, discussion, and activity. This cannot be
            undone.
          </p>
        </div>
      </div>
