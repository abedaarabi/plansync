...
import { Link2, MapPin, Package, PanelRightOpen, Pencil } from "lucide-react";
                ...
                <div className="inline-flex flex-nowrap items-center justify-end gap-1">
                  ...
                  {a.fileId ? (
                    <button
                      type="button"
                      aria-label={
                        assetHasSheetPin(a) ? `View pin for ${a.tag}` : `Open drawing for ${a.tag}`
                      }
                    ...
                    >
                      ...
                      <span className="hidden md:inline">
                        {assetHasSheetPin(a) ? "Pin" : "Drawing"}
                      </span>
                    </button>
                  ) : null}
                  <button
                  ...
                  {a.fileId ? (
                    <button
                      type="button"
                      aria-label={`Clear drawing link for ${a.tag}`}
