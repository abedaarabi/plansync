...
/** Bottom-left region: the level's IFC cut plan with numbered pick markers. */
export function PlanPickPane({
  ...
  return (
    <div className="registration-pane relative flex min-h-0 flex-1 flex-col">
      ...
      {engine ? (
        <PickPaneViewport pickTargetRef={canvasRef} pickActive={planPickActive} onPick={onPlanPick}>
          {({ zoom }) => (
