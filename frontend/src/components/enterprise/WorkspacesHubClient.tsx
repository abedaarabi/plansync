...
export function WorkspacesHubClient() {
  ...
  return (
    <div className="mobile-app-page w-full min-w-0 max-w-full enterprise-animate-in flex min-h-[min(560px,70vh)] flex-col items-center justify-center px-4 py-10">
      <div className="w-full max-w-md rounded-lg border border-[var(--enterprise-border)] bg-[var(--enterprise-surface)] p-6 shadow-[var(--enterprise-shadow-md)] sm:p-8">
        <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-md bg-[var(--enterprise-primary)]/10 text-[var(--enterprise-primary)]">
          ...
          {me.workspaces.map((mw) => (
            <li key={mw.workspace.id}>
              <button
                ...
                className="flex w-full items-center gap-3 rounded-md border border-[var(--enterprise-border)] bg-[var(--enterprise-bg)] px-4 py-3 text-left text-sm font-medium text-[var(--enterprise-text)] transition hover:border-[var(--enterprise-primary)]/40 hover:bg-[var(--enterprise-hover-surface)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--enterprise-primary)]/30"
              >
