  ...
  return (
    <QueryProvider>
      <EnterpriseWorkspaceProvider>
        ...
        <ProjectContextSync />
        {isWorkspaceGate ? (
          <div className="enterprise-app-shell flex h-dvh min-h-0 w-full min-w-0 max-w-full flex-col overflow-x-hidden bg-[var(--enterprise-bg)] text-[var(--enterprise-text)] lg:flex-row">
            {mobileNavOpen && (
              <button
                type="button"
