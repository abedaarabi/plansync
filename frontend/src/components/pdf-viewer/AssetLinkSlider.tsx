    ...
    <>
      <div className="fixed inset-0 z-[120]" role="presentation">
        ...
        <aside
          ...
          className="absolute right-0 top-0 flex h-full w-full max-w-[min(480px,calc(100vw-1rem))] flex-col border-l border-slate-700/80 bg-slate-950 shadow-[-16px_0_48px_-12px_rgba(0,0,0,0.55)]"
