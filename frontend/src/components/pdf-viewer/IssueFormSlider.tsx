    ...
    <>
      ...
      >
        ...
        <aside
          ...
          className="absolute right-0 top-0 flex h-full w-full min-w-0 max-w-[min(640px,calc(100dvw-1rem))] flex-col overflow-x-hidden border-l border-slate-700/80 bg-slate-950 shadow-[-16px_0_48px_-12px_rgba(0,0,0,0.55)]"
