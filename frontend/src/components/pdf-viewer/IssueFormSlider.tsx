...
export function IssueFormSlider(props: Props) {
  ...
  const [sectionAssignment, setSectionAssignment] = useState(true);
  const [sectionSchedule, setSectionSchedule] = useState(variant === "edit");
      ...
      >
        ...
        <div className={`${viewerOperationsMode ? "space-y-4 pb-1" : "space-y-6 pb-2"}`}>
          ...
          <CollapsibleSection
            ...
            title={viewerOperationsMode ? "Execution" : "Status & assignment"}
            open={sectionAssignment}
            onToggle={() => setSectionAssignment((v) => !v)}
          >
              ...
              {assigneePickerOpen ? (
                ...
                >
                  ...
                  >
                    ...
                    {assignableMembers.length > 0 && assigneePickerMembersFiltered.length === 0 ? (
          ...
          <CollapsibleSection
            id="issue-section-schedule"
            title={viewerOperationsMode ? "Location & schedule" : "Location & dates"}
