...
function ToggleRow({
  ...
  return (
    <label
      className={`flex cursor-pointer items-start gap-2 rounded-md border border-slate-200 bg-slate-50 px-2 py-1.5 text-[11px] text-slate-700 ${disabled ? "cursor-not-allowed opacity-50" : ""}`}
    >
      <input
        id={id}
        type="checkbox"
...
export function SheetExportDialog({ open, onClose, pdfDoc, exportCanvasRef }: Props) {
  ...
  return (
    <div
      className="mobile-sheet-host fixed inset-0 z-[100] flex items-center justify-center bg-white p-4 backdrop-blur-[2px] max-lg:items-end max-lg:p-0"
      role="presentation"
      onMouseDown={(e) => {
    ...
    >
      <div
        className="mobile-sheet-panel relative flex max-h-[min(90vh,720px)] w-full max-w-lg flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl ring-1 ring-black/25 max-lg:max-h-[min(92dvh,920px)] max-lg:rounded-t-2xl max-lg:rounded-b-none"
        role="dialog"
      ...
      >
        <div className="flex shrink-0 items-center justify-between gap-2 border-b border-slate-200 px-4 py-3">
          <h2 id="sheet-export-title" className="text-sm font-semibold text-slate-900">
            Export & print
          </h2>
          <button
            type="button"
        ...
        <div className="min-h-0 flex-1 overflow-y-auto px-4 py-3 [scrollbar-width:thin]">
          <p className="mb-2 text-[11px] leading-relaxed text-slate-500">
            Choose what to burn into <strong className="font-medium text-slate-600">PDF</strong> and{" "}
            <strong className="font-medium text-slate-600">PNG</strong> exports. Presets and
          ...
          <ul className="mb-3 list-inside list-disc space-y-1 text-[10px] leading-relaxed text-slate-500">
            <li>
              <strong className="font-medium text-slate-500">Menu:</strong>{" "}
              <strong className="text-slate-500">Document info</strong> and{" "}
              <strong className="text-slate-500">Shortcuts</strong> are in the top bar menu (lines
              icon), not here.
            </li>
            <li>
              <strong className="font-medium text-slate-500">Tip:</strong> use{" "}
              <strong className="text-slate-500">Download PDF</strong> for a clean, shareable sheet;
              browser print keeps the full viewer chrome unless you use print preview settings.
            </li>
            <li>
              Export <strong className="text-slate-500">JSON</strong> before big edits or
              experiments — it is your full markup backup for this file.
            </li>
            <li>
              CSV / issue / takeoff reports always list{" "}
              <strong className="text-slate-500">all</strong> rows for the sheet (not filtered by
              the checkboxes).
            </li>
          </ul>
          ...
          <div className="mb-2 flex flex-wrap gap-1.5">
            <button
              ...
              className="rounded-md border border-slate-300 bg-slate-100 px-2 py-1 text-[10px] font-medium text-slate-700 hover:bg-slate-200"
            >
              All on
            </button>
            <button
          ...
          {pdfMode === "custom" && (
            <input
              ...
              disabled={pdfBusy}
              className="mb-2 w-full rounded-md border border-slate-200 bg-white px-2 py-1.5 text-[11px] text-slate-900 placeholder:text-slate-600"
            />
          )}
          {pdfError ? <p className="mb-2 text-[11px] text-red-400">{pdfError}</p> : null}
          {pdfBusy && pdfProgress ? (
            <p className="mb-2 flex items-center gap-2 text-[11px] text-slate-500">
          ...
          <button
            ...
            className="mb-4 flex w-full items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
          >
            <ImageIcon className="h-3.5 w-3.5 shrink-0 text-[var(--viewer-icon)]" />
          ...
          <div className="flex flex-col gap-1.5">
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
            >
              <FileJson className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
            >
              <Table className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
            >
              <Package className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
              Export takeoff CSV
            </button>
            <button
              type="button"
              ...
              className="flex items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
            >
              <Printer className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
            >
              <ClipboardList className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
              Print issues report
            </button>
          </div>
          ...
          <button
            ...
            className="flex w-full items-center gap-2 rounded-md border border-slate-300 bg-slate-100 px-3 py-2 text-left text-[11px] text-slate-900 hover:bg-slate-200 disabled:opacity-40"
          >
            <Printer className="h-3.5 w-3.5 text-[var(--viewer-icon)]" />
            Print sheet (browser)
          </button>
